...
import animatedTopics from "@/assets/images/super-blog-brothers/blog-animated-topics.gif";
...
const links: SocialLink[] = [
  {
    ...
    href: "https://video-game-blog-beta.vercel.app/",
  ...
  },
  {
    ...
    href: "https://github.com/GregM1991/video-game-blog",
    icon: FaGithub,
...
const images = [
  {
    ...
    caption: (
      <Typography size="xs">
        ...
        <AnimatedLink href="https://github.com/GregM1991/video-game-blog/blob/main/src/lib/slices/Hero/index.svelte#L72">
          here
        </AnimatedLink>
      </Typography>
    ),
  ...
  },
  {
    ...
    caption: (
      <Typography size="xs">
        ...
        <AnimatedLink href="https://video-game-blog-beta.vercel.app/blog">
          Check them out here
        </AnimatedLink>
        , or check out the code{" "}
        <AnimatedLink href="https://github.com/GregM1991/video-game-blog/blob/main/src/lib/slices/ContentIndex/ContentList.svelte">
          here
        </AnimatedLink>
      </Typography>
    ),
  ...
  {
    key: 2,
    src: animatedTopics, // TODO: Change this to the correct image (animated topics)
    ...
    caption: (
      <Typography size="xs">
        ...
        <AnimatedLink href="https://video-game-blog-beta.vercel.app/about">
          Check it out here
        </AnimatedLink>
        , or check out the code{" "}
        <AnimatedLink href="https://github.com/GregM1991/video-game-blog/blob/main/src/lib/slices/TopicList/index.svelte">
          here
        </AnimatedLink>
      </Typography>
    ),
