...
const DEMAND_CONFIG_SCREENS = [
  ...
  {
    key: "demand-config-segment-expanded",
  ...
  {
    key: "demand-config-segment-edit",
...
const GLOBAL_SUPPLY_SCREENS = [
  {
    key: "global-supply-not-selected",
  ...
  {
    key: "global-supply-filter-selection",
    src: filterSelection,
  ...
  {
    key: "global-supply-upload-progress-1",
  ...
  {
    key: "global-supply-upload-progress-2",
...
export const OPENING = {
  ...
  body: [
    ...
    {
      key: "eq8-opening-startup-lessons",
...
export const GOALS = {
  ...
  body: [
    ...
    {
      key: "eq8-goals-step-out-comfort",
...
export const CHALLENGES = {
  ...
  body: [
    ...
    {
      key: "eq8-challenges-legacy-code",
...
export const DEMAND_CONFIG = {
  ...
  contribution: {
    ...
    body: [
      {
        key: "demand-config-contribution-react",
      ...
      {
        key: "demand-config-contribution-design-feedback",
      ...
      {
        key: "demand-config-contribution-crud-apis",
...
export const GLOBAL_SUPPLY_UPLOAD = {
  ...
  contribution: {
    ...
    body: [
      {
        key: "global-supply-contribution-ui",
      ...
      {
        key: "global-supply-contribution-api",
