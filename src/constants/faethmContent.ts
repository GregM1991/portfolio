...
export const OPENING = {
  ...
  body: [
    {
      key: "faethm-opening-description",
...
export const CHALLENGES = {
  ...
  body: [
    {
      key: "faethm-challenges-tech-debt",
    ...
    {
      key: "faethm-challenges-legacy-redux",
    ...
    {
      key: "faethm-challenges-learning",
...
export const IN_HOUSE_IDENTITY_TO_AUTH0: SpotlightContent = {
  ...
  contribution: {
    ...
    body: [
      ...
      {
        key: "auth0-frontend-integration",
...
export const SUPPLY_DEMAND_MODEL: SpotlightContent = {
  ...
  contribution: {
    ...
    body: [
      {
        key: "supply-demand-architecture",
      ...
      {
        key: "supply-demand-implementation",
