export const values = [
  ...
  {
    key: "pursue-excellence",
    title: "Pursue Excellence",
    body: "Having two older brothers instilled a healthy sense of competition in me from as far back as I can remember. I think this plays a big part in my pursuit of excellence. I enjoy learning, honing the knowledge I pick up and hold a great sense of pride in my achievements (however big or small)."
  },
  {
    key: "make-complex-things-simple",
    title: "Make Complex Things Simple",
    body: "Over the course of my career this value has evolved into somewhat of a North Star for me. It's quite easy to over-engineer something that only needed a light touch, so it's important to take time at the beginning of a project to assess the most efficient path from A to B - I find this so valuable to achieving the best possible final product."
  }
];
